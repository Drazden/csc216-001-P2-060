...
public interface SimpleList<E> {
     ...
     * @throws IndexOutOfBoundsException if the index is out of range (index negative
     *             or at least as great as size())
     */
    E remove(int index);
     ...
     * @throws IndexOutOfBoundsException if the index is out of range (pos negative
     *             or at least as great as size())
     */
    E get(int pos);
