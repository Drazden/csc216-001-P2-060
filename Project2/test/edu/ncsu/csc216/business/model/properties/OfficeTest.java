...
//		Office office = new Office("11-11", 75);
//		Client client = new Client("Jacob", "Jacob");
//		LocalDate start = LocalDate.of(2020, 4, 1);
//		try {
//			office.reserve(client, start, 1, 40);
//		} catch (RentalDateException | RentalCapacityException | RentalOutOfServiceException e) {
//			e.printStackTrace();
//		}
//		assertEquals(35, office.remainingCapacityFor(start));
//		
//		try {
//			office.reserve(client, start, 1, 1);
//		} catch (RentalDateException | RentalCapacityException | RentalOutOfServiceException e) {
//			e.getMessage();
//		}
//		assertEquals(34, office.remainingCapacityFor(start));
//		
//	
